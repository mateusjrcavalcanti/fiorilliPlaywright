/*
  ...
  - You are about to drop the column `Mes` on the `Transferencia` table. All the data in the column will be lost.
  - You are about to drop the column `Previsto` on the `Transferencia` table. All the data in the column will be lost.
