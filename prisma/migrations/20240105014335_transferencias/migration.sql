...
INSERT INTO "new_Transferencia" ("CNPJEntRecebedora", "CNPJEntpagadora", "Concedida", "Data", "EntidadePagadora", "EntidadeRecebedora", "Exercicio", "Historico", "Mes", "Previsto", "Recebida", "anoId", "id") SELECT "CNPJEntRecebedora", "CNPJEntpagadora", "Concedida", "Data", "EntidadePagadora", "EntidadeRecebedora", "Exercicio", "Historico", "Mes", "Previsto", "Recebida", "anoId", "id" FROM "Transferencia";
